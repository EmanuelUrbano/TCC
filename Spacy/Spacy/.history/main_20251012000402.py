...
def extract_section_body(file_path: str, doc_titulo_buscado: str) -> dict or None:
    """
    ...
    try:
        ...
        for span in doc.spans["layout"]:
            ...
            doc_titulo_extraido = nlp_pt(titulo_extraido)

            lemmas_titulo_buscado =[token.lemma_.lower() for token in doc_titulo_buscado]
            lemmas_titulo_extraido = [token.lemma_.lower() for token in doc_titulo_extraido]
            

            print(lemmas_titulo_buscado)
            print(lemmas_titulo_extraido)

            if span.label_ == "section_header" and any(item in lemmas_titulo_extraido  for item in lemmas_titulo_buscado):
            ...
            if in_target_section:
                ...
                if span.label_ == "section_header" and not (any(item in lemmas_titulo_extraido  for item in lemmas_titulo_buscado)):
...
if __name__ == "__main__":
    ...
    if not arquivos:
        ...
        for document_path in arquivos:
            ...
            extracted_content = extract_section_body(document_path, doc_titulo)
